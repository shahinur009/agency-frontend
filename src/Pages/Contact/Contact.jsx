...
const Contact = () => {
  ...
  const contactSections = [
    {
      items: [
        {
          title: "Мэдээллийн төв:",
          content: "1800-1882 / Ахлах мэргэжилтэн Д. Шинэбаатар",
          type: "phone",
        },
        {
          title: "E-register авах:",
          content: "support@immigration.gov.mn",
          type: "email",
        },
        {
          title: "Бичиг хэрэг:",
          content: "7013-3458 letter@immigration.gov.mn",
          type: "mixed",
        },
        {
          title: "Виз зөвшөөрлийн газар:",
          content: "7013-3457",
          type: "phone",
        },
        {
          title: "Иргэний харьяатын газар:",
          content: "7013-3459",
          type: "phone",
        },
      ],
    },
    {
      items: [
        {
          title: "Зөрчил шалган шийдвэрлэх газар:",
          content: "7013-3448",
          type: "phone",
        },
        {
          title: "Өргөдөл, гомдол хариуцсан мэргэжилтэн:",
          content: "7013-3480 / Ц.Цэрэнхүү III давхар",
          type: "phone",
        },
        {
          title: "Олон нийттэй харилцах:",
          content: "7013-3445 / Ч.Гантуяа III давхар 308 тоот",
          type: "phone",
        },
        {
          title: "Жижүүр:",
        ...
        {
          title: "Цахим шуудан:",
          content: "letter@immigration.gov.mn",
          type: "email",
        },
      ],
    },
    {
      items: [
        {
          title: "Визийн мэдээлэл:",
          content: "visasection@immigration.gov.mn",
          type: "email",
        },
        {
          title: "Гадаад харилцаа:",
          content: "foreignrelations@immigration.gov.mn",
          type: "email",
        },
        {
          title: "Хаяг:",
          content:
            "Улаанбаатар хот, Хан-Уул дүүрэг, 21-р хороо, Буянт-Ухаа дэнж, Гадаадын иргэн, харьяатын газар",
          type: "address",
        },
        {
          title: "Онлайн сүлжээ:",
          ...
          social: [
            {
              name: "Facebook",
              url: "#",
              handle: "Immigration Agency of Mongolia",
              icon: (
  ...
  // Map pin locations (coordinates as percentages from top-left)
  const mapPins = [
    { top: "83%", left: "52%", label: "Гол байр" },
    { top: "78%", left: "40%", label: "Гол байр" },
    { top: "70%", left: "30%", label: "Гол байр" },
    { top: "60%", left: "20%", label: "Гол байр" },
    { top: "32%", left: "19%", label: "Харилцааны төв" },
    { top: "20%", left: "45%", label: "Зочдын байр" },
    { top: "53%", left: "80%", label: "Онлайн" },
    { top: "63%", left: "70%", label: "Жижүүр" },
    { top: "33%", left: "75%", label: "Онлайн" },
    { top: "32%", left: "55%", label: "Жижүүр" },
  ];

  // Function to render contact content based on type
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Бид таны асуулт, санал хүсэлтийг цаг тухайд нь шийдвэрлэхэд бэлэн
            байна
          </p>
        </div>
            ...
            <div key={sectionIndex} className=" transition-shadow duration-300">
              {section.items.map((item, itemIndex) => (
                <div
                  key={itemIndex}
                  className={`${
                    itemIndex !== section.items.length - 1 ? "mb-6" : ""
                  }`}
                >
